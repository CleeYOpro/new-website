  ...
  return (
    <header className="site-nav" aria-label="Home">
      ...
      <div className="nav-icons" aria-label="Settings">
        <a href="https://instagram.com/cle0b" target="_blank" rel="noreferrer" aria-label="Instagram" className="nav-icon-link">
          <FaInstagram size={16} />
        </a>
        <a href="https://github.com/CleeYOpro" target="_blank" rel="noreferrer" aria-label="GitHub" className="nav-icon-link">
          <FaGithub size={16} />
        </a>
        <a href="https://linkedin.com/in/cleofus" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="nav-icon-link">
          <FaLinkedin size={16} />
        </a>
